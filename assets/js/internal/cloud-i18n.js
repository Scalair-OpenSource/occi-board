...
var registerCloudI18N = function (parent) {
    ...
    parent.loadLocales = function (lang, callback) {
        $.getJSON('/locales/' + lang, function (data) {
            parent._i18n_cache = data;
            ...
            /*
             * Set date format (see sugarjs and momentjs)
             */
            loadTimezone();
            Date.setLocale(getCurrentLocaleCode());
            //~ moment.lang(getCurrentLocaleCode());
    ...
    /**
     * Method: __ (two underscores)
     * Return the translation of a message
     *
     * Parameters:
     * id - The message to translate
     * data - Object with values to introduce into translation, as variable.
     *
     * Example:
     * | __("Welcome!") --> "Bonjour !"
    ...
    var __ = parent.__ = function (id, data) {
        try {
            return parent._i18n_cache[id].assign(data);
        }
        catch (e) {
            console.error('[i18n] not found: "' + id + '"');
            return id.assign(data);
        }

        //~ if (parent._i18n_cache[id]) {
            //~ return parent._i18n_cache[id].assign(data);
        //~ }
        //~ else {
